...
define void @print3(x86_fp80*) {
entry:
  %1 = sitofp i16 1 to x86_fp80
  store x86_fp80 %1, x86_fp80* %0
  ret void
}

define void @print2(x86_fp80*) {
entry:
  call void @print3(x86_fp80* %0)
  ret void
}

define void @print1(x86_fp80*) {
entry:
  call void @print2(x86_fp80* %0)
  ret void
}
...
entry:
  %0 = alloca x86_fp80
  call void @print1(x86_fp80* %0)
  %1 = load x86_fp80, x86_fp80* %0
  call void @writeReal.(x86_fp80 %1)
  ret void
}
