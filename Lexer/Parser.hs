...
happyReduction_1 ((HappyAbsSyn4  happy_var_6) `HappyStk`
	...
	_ `HappyStk`
	(HappyTerminal (Var _ happy_var_2)) `HappyStk`
	_ `HappyStk`
	happyRest)
	 = HappyAbsSyn4
...
happyReduction_11 (HappyTerminal (Int _ happy_var_1))
	 =  HappyAbsSyn8
		 (IntE happy_var_1
	)
...
happyReduction_12 (HappyTerminal (Var _ happy_var_1))
	 =  HappyAbsSyn8
		 (VarE happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	Let _ -> cont 9;
	In  _ -> cont 10;
	Int _ happy_dollar_dollar -> cont 11;
	Var _ happy_dollar_dollar -> cont 12;
	Sym _ '=' -> cont 13;
	Sym _ '+' -> cont 14;
	Sym _ '-' -> cont 15;
	Sym _ '*' -> cont 16;
